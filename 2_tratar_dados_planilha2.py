...
df = pd.read_csv("Planilha_2.csv", encoding='latin1', sep=';')
...
df.to_csv("dados_tratados_2_com_datahora.csv", index=False)

print("Arquivo tratado salvo como 'dados_tratados_2_com_datahora.csv'")