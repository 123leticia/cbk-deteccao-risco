...
print("Random Forest com SMOTE Accuracy:", accuracy_score(y_test, rf_preds))
print("Random Forest com SMOTE Report:\n", classification_report(y_test, rf_preds))

# Logistic Regression com class_weight
lr_model = LogisticRegression(max_iter=1000, class_weight='balanced', random_state=42)
lr_model.fit(X_train, y_train)
lr_preds = lr_model.predict(X_test)
print("Logistic Regression com class_weight Accuracy:", accuracy_score(y_test, lr_preds))
print("Logistic Regression com class_weight Report:\n", classification_report(y_test, lr_preds))

# XGBoost com SMOTE
xgb_model = XGBClassifier(use_label_encoder=False, eval_metric='logloss', scale_pos_weight=1, random_state=42)
xgb_model.fit(X_train, y_train)
xgb_preds = xgb_model.predict(X_test)
print("XGBoost com SMOTE Accuracy:", accuracy_score(y_test, xgb_preds))
print("XGBoost com SMOTE Report:\n", classification_report(y_test, xgb_preds))
